...
def standardizeTeamName(name, league):
    ...
    if (league == "Japan1"):
        ...
        if ("thespakusatsu" in lname):
            ...
            return ("FC Ryukyu")
        elif ("grulla morioka" in lname):
            return ("Grulla Morioka")
        else:
            return (name)
    elif (league == "Korea1"):
        ...
        elif ("ulsan hyundai" in lname or "ulsan" == lname):
        ...
        if ("lillestrom sk" in lname or "lillestrøm" in lname):
            ...
            return ("Sogndal")
        elif ("ik start" in lname or "start" == lname):
        ...
        elif ("osters if" in lname or "Ã\x96ster" == name):
            return ("Osters IF")
        ...
        if ("flamengo" in lname):
            ...
            return ("Parana PR")
        elif ("centro sportivo alagoano" in lname or "csa" == lname):
        ...
        if ("vejle boldklub" in lname):
            ...
            return ("Aarhus AGF")
        elif ("aab" == lname or "aalborg" in lname):
            return ("Aalborg")
            ...
            return ("Randers FC")
        elif ("copenhagen" == lname or "KÃ¸benhavn" == name):
            return ("FC Copenhagen")
        elif (" odense" in lname or "ob" == lname):
            return ("Odense BK")
        ...
        if ("desportivo aves" in lname):
            ...
            return ("Benfica")
        elif ("vizela" in lname):
            return ("Vizela")
        elif ("naval 1" in lname):
        ...
        if ("nk krsko" in lname or "KrÅ¡ko" == name):
        ...
        if ("alavés" in lname):
            return ("Alaves")
        elif ("valladolid" in lname):
            return ("Real Valladolid")
        elif ("villarreal" in lname):
            return ("Villarreal")
