...
data = read.csv("C:/Users/JackMitt/Documents/EPLBettingModel/EPL_Csvs/3Game_newvars_no_T/poissonFormattedData3Games.csv")
...
write.csv(data, "C:/Users/JackMitt/Documents/EPLBettingModel/EPL_Csvs/3Game_newvars_no_T/poissonFormattedData3Games.csv")
