...
data = read.csv("C:/Users/JackMitt/Documents/EPLBettingModel/EPL_Csvs/no_T_Vars/poissonFormattedDataNoT.csv")
### Find indices manually
train = data[1:1850,,drop=F]
test = data[1851:3036,,drop=F]
...
write.csv(test, "C:/Users/JackMitt/Documents/EPLBettingModel/EPL_Csvs/no_T_Vars/poissonPredictionMeansTestSplit.csv")