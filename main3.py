...
for league in leagues:
    ...
    #eval.analyzeWinRates(league, "AH", "Open", file = "/bayes_predictions_newGood.csv")
    #eval.kellybet(league, "AH", "Open", 20000, 8, 0.1, file = "/bayes_predictions.csv")
